      ...
      <div className="footer-container">
        <div className="footer-top">
          <div className="footer-logo-box">
            ...
            <div className="footer-logo-text">{'Hyeseong Board'}</div>
          </div>
          <div className="footer-link-box">
            <div className="footer-email-link">hyeseong43@gmail.com</div>
        ...
        <div className="footer-bottom">
          <div className="footer-copyright">{'Copyright @ 2022 Hyeseong. All Rights Reserved'}</div>
        </div>
      </div>
    </div>
  )
